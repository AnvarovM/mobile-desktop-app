    ...
    <div className="grid min-h-screen place-items-center">
      <div className="mx-auto h-full w-full  rounded-[60px] border-[14px] border-black relative overflow-hidden ring ring-purple-50 shadow-xl">
        ...
        <div className="relative">
          ...
          {/* call numbers */}
        <div className="absolute top-1/4 inset-x-8">
          <div className="grid grid-cols-3 place-items-center gap-4 items-center">
            <div>
              <p className="call-number-first">1</p>
            </div>
          ...
          <div className="w-16 h-16 z-10 mt-7 mx-auto cursor-pointer filter hover:brightness-90">
            <img
              className=""
              src="https://www.clipartmax.com/png/full/124-1243931_phone-services-mobile-call-logo-png.png"
              alt=""
            />
          </div>
        </div>
